# This file is used for scrappign data for Legislative assemblies across the Indian state of Uttar Pradesh. 
This data will be further processed to create url for getting pdf file (electoral roll) from election commision website.
